...
"""
# Build a 3-frames kitti dataset with (256, 832) resolution
python3 data_preparation/kitti_data_prepare.py \
        --dataset_dir=/home/mjchiu/Documents/darknet-depth/dataset/KITTI/image/ \
        --dataset_name=kitti_raw_eigen \
        --dump_root=/home/waterman/Unsupervised_depth_flow_pose/datasets/kitti_3frames_128_416/ \
        --seq_length=3 \
        --img_height=256 \
        --img_width=832 \
        --num_threads=16 \
...
# Build a 5-frames kitti dataset with (128, 416) resolution
python3 data_preparation/kitti_data_prepare.py \
        --dataset_dir=/home/mjchiu/Documents/darknet-depth/dataset/KITTI/image/ \
        --dataset_name=kitti_raw_eigen \
        --dump_root=/home/waterman/Unsupervised_depth_flow_pose/datasets/kitti_3frames_128_416/ \
...
#     scipy.misc.imsave(dump_img_file, image_seq.astype(np.uint8))
    im = Image.fromarray(image_seq.astype(np.uint8))
    im.save(dump_img_file)
